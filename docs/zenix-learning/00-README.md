...
| [courses/02-front-office-excellence/](courses/02-front-office-excellence/) | **Curso 2 en producción (Día 7, 2026-05-22)** — Outline (9 módulos · ~27 lessons · AHLEI CFDR-aligned, CERO terminología Zenix) + Módulo 1 (3 lessons: industria + rol estratégico recepción + ciclo huésped Kotler + FOH/BOH). Próximo: Módulos 2-9. | Contenido |
