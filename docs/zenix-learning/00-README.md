...
| [courses/03-housekeeping-standards/](courses/03-housekeeping-standards/) | **Curso 3 en producción (Día 10, 2026-05-22)** — Outline (10 módulos · ~28 lessons · AHLEI CHHE-aligned, CERO terminología Zenix) + M1 introducción operaciones HK (3 lessons: housekeeping como disciplina + limpio vs desinfectado + room status codes + MPI + coordinación). Capstone Game F "Room Inspector" (M9). Próximo: Módulos 2-10. | Contenido |
