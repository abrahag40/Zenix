...
> **Última actualización:** 2026-05-22 (Día 5) — docs 21-24 publicados + **🎉 CURSO 1 COMPLETO al 100%** (8 módulos · 28 lessons): M1 Marco normativo + M2 Zona peligro+ETAs + M3 11 áreas+28 puntos críticos (capstone Game A Fase 1.4) + M4 Higiene manipulador + M5 Limpieza/desinfección/códigos + M6 NOM-035 marco+5 factores+violencia laboral + M7 Guías I/II/III + M8 Política+evidencia+plan acción+protocolo violencia. Bibliografía consolidada: NMX-F-605 + Manual SECTUR + NOM-035 + Guías I/II/III/IV/V STPS + LFT + ILO C190 + WHO + CDC + WHO + FDA + EPA + Codex Alimentarius + ISO 22000 + NSF + UK FSA + OSHA + Sailer&Homner + Cialdini + Deci&Ryan + Karasek + Siegrist + Reason. Próximo Día 6: question bank examen final 60 preguntas + caso práctico + generador certificado co-branded.
...
| [courses/01-distintivo-h-nom-035/](courses/01-distintivo-h-nom-035/) | **🎉 CURSO 1 COMPLETO al 100% (2026-05-22)** — Outline + 8 módulos (28 lessons) redactados: M1 Marco normativo (3) + M2 Zona peligro+ETAs (4) + M3 11 áreas+28 puntos críticos (5, capstone Game A) + M4 Higiene manipulador (3) + M5 Limpieza/desinfección/códigos (4) + M6 NOM-035 marco+5 factores+violencia laboral (3) + M7 Guías I/II/III (3) + M8 Política+evidencia+plan acción+protocolo violencia (3). Pendiente Día 6: question bank examen final 60 preguntas + caso práctico + generador certificado co-branded. | Contenido |
