...
> **Última actualización:** 2026-05-22 (Día 6) — docs 21-24 publicados (incluyendo §1.1.bis Quiz Randomization Standard universal) + **🎉 CURSO 1 COMPLETO al 100% incluyendo Día 6 cierre**: outline + 8 módulos (28 lessons) + question-bank (300 preguntas ratio 5×) + final-exam-spec (60 examen + caso práctico foto-evidencia) + certificate-generation-spec (PDF co-branded + endpoint /verify HMAC-SHA256). Bibliografía consolidada: NMX-F-605 + Manual SECTUR + NOM-035 + Guías I/II/III/IV/V STPS + LFT + ILO C190 + WHO + CDC + FDA + EPA + Codex Alimentarius + ISO 22000 + NSF + UK FSA + OSHA + NIOSH + Cornell + Kotler + Cialdini + Hofstede + Heskett + Sailer&Homner + Deci&Ryan + Karasek + Siegrist + Reason + ServSafe + ABMP + AHLEI CFDR/CHHE benchmarks. **🎉🎉🎉 LOS 3 CURSOS DEL CATÁLOGO MVP COMPLETOS — 83 lessons (Curso 1: 28 + Curso 2: 27 + Curso 3: 28).** Pendiente Día 13: question banks Cursos 2+3 (200+250 ratio 5×) + specs examen final + cleanup + handover producción-ready.
...
| [courses/01-distintivo-h-nom-035/](courses/01-distintivo-h-nom-035/) | **🎉 CURSO 1 COMPLETO al 100% incluyendo Día 6 (2026-05-22)** — Outline + 8 módulos (28 lessons) + question-bank.md (300 preguntas ratio 5×) + final-exam-spec.md (60 examen + caso práctico) + certificate-generation-spec.md (PDF co-branded + endpoint /verify HMAC). | Contenido |
| [courses/02-front-office-excellence/](courses/02-front-office-excellence/) | **🎉 CURSO 2 COMPLETO al 100% (Días 7-9, 2026-05-22)** — Outline + 9 módulos (27 lessons) AHLEI CFDR-aligned, CERO terminología Zenix: M1 industria/rol + M2 tecnología + M3 pre-arrival + M4 check-in (Game D) + M5 folio/PCI-DSS + M6 check-out/disputas + M7 servicio/LEARN + M8 seguridad/datos + M9 no-shows/fiscal/cierre. Pendiente: question bank 200 + spec examen final. | Contenido |
| [courses/03-housekeeping-standards/](courses/03-housekeeping-standards/) | **🎉 CURSO 3 COMPLETO al 100% (Días 10-12, 2026-05-22)** — Outline + 10 módulos (28 lessons) AHLEI CHHE-aligned, CERO terminología Zenix: M1 introducción + M2 planning/MPI + M3 químicos/SDS + M4 SOPs limpieza + M5 lencería/biohazard + M6 sustainability + M7 bioseguridad/cross-DistintivoH + M8 maintenance/Lost&Found + M9 QA/inspections (Game F) + M10 seguridad personal/ergonomía. Pendiente: question bank 250 + spec examen final. | Contenido |
