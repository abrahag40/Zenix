...
| [courses/02-front-office-excellence/](courses/02-front-office-excellence/) | **Curso 2 en producción ~48% (Días 7-8, 2026-05-22)** — Outline (9 módulos · ~27 lessons · AHLEI CFDR-aligned, CERO terminología Zenix) + M1 industria/rol recepción (3) + M2 tecnología recepción (3) + M3 pre-arrival/reservaciones (3) + M4 check-in excelente (4, capstone Game D). Próximo: Módulos 5-9 + question bank. | Contenido |
