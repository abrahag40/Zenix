...
| [courses/03-housekeeping-standards/](courses/03-housekeeping-standards/) | **Curso 3 en producción ~57% (Días 10-11, 2026-05-22)** — Outline (10 módulos · ~28 lessons · AHLEI CHHE-aligned, CERO terminología Zenix) + M1 introducción + M2 planning/forecasting/MPI + M3 químicos/SDS/seguridad + M4 SOPs limpieza (top-down/clean-to-dirty/bed making/terminal) + M5 lencería/lavandería/biohazard. Capstone Game F (M9). Próximo: Módulos 6-10. | Contenido |
