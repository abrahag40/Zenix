> 🗄️ **ARCHIVADO el 2026-09-23.** Venía de `docs/ops/testing-master-plan.md`. Sin referencias entrantes y sin
> tocarse desde el 2026-06-06. Se conserva porque registra qué se decidió y qué se midió;
