> 🗄️ **ARCHIVADO el 2026-09-23.** Venía de `docs/sprints/RESERVATION-EDIT-PRECHECKIN-plan.md`. Sin referencias entrantes y sin
> tocarse desde el 2026-06-16. Se conserva porque registra qué se decidió y qué se midió;
