...
### Sprint 2 — E2 Arqueo + spot count + E3 Cash movements (backend)
...
### Sprint 3 — E4 Reportes de caja (backend)
...
### Sprint 4 — E5 Frontend recepción
...
### Sprint 5 — E6 Frontend reportes + settings + spot count del supervisor
