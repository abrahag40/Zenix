...
| [**18-conexion-website-hotel.md**](18-conexion-website-hotel.md) | 🟢 **DESARROLLO PRIORITARIO.** Cómo se conecta el sitio de un hotel a Zenix en una sesión de trabajo: el contrato del «sobre de tarifas», el conector PHP para hosting compartido, su modelo de amenazas, y el orden de construcción por dependencia real | Ingeniería, producto, owner |
