  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-30 flex items-center gap-3 px-4 h-14 bg-white border-b border-slate-200">
      ...
      <div className="flex items-center gap-1">
        ...
        {/* Bell + panel — implementación compartida con TimelineTopBar.
            Antes había 2 implementaciones duplicadas (una en este archivo,
            otra stub en TimelineTopBar). Extraída a @/components/NotificationBell. */}
        <NotificationBell />
