...
- **Sprint ACTIVO:** ⏳ entre sprints. Último sprint cerrado: **BILLING-DISCOUNT-CODES** (5/5 días, 2026-05-27 — branch `feature/billing-discount-codes` pending merge a `feature/billing-core` → `main`). 242/242 tests verdes. Sprint anterior: **BILLING-CORE** Days 1-8 cerrados 2026-05-27 — Stripe subscriptions LIVE end-to-end + wizard E2E + receipt email template Anthropic-inspired.
