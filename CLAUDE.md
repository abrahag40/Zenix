...
- **Sprint ACTIVO:** **CLIENT-RETENTION-DISCOUNTS** (siguiente, owner-requested). **Wizard Zenix Activate cerrado oficialmente 2026-05-29** — sprint WIZARD-CLOSE marca el fin de la fase wizard de v1.0.0. 24 decisiones §200-§223 consolidadas en sección "Wizard Zenix Activate — cerrado oficialmente v1.0.0" del CLAUDE.md. PRs mergeados a main: #47-#52 (6 sprints). Orden restante v1.0.0: CLIENT-RETENTION-DISCOUNTS (1-2d) → CHECK-IN modal redesign → RATES-METRICS-COMPSET-CORE → QA-α → CI-RESCUE → Channex Stage 4 walkthrough → tag v1.0.0. Total ~25-36 días-dev = ~7-8 sem calendar. Target ago-sep 2026.
