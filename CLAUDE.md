...
> **Estado:** **Sprints 0-4 CERRADOS (2026-06-13/14)**. Sprints 5-6 pendientes. Plan SCRUM completo en **[docs/sprints/MIGRATION-CORE-plan.md](docs/sprints/MIGRATION-CORE-plan.md)**. Módulo comercial 9 en [zenix-sales-master.md](docs/zenix-sales-master.md). v1.1.x DLC/servicio — **NO bloquea v1.0.0**. **Sprint 4 NO mergeado a main** (deploy a prod = al final del desarrollo, instrucción owner 2026-06-14 — mergear a main dispara auto-deploy Render+Vercel). **Próximo: Sprint 5 (runbook servicio asistido + spike 2º adapter Mews).**
>
