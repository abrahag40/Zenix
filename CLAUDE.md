...
- **Plan de trabajo Bloque 1 (release v1.0.0):** **CHANNEX-INBOUND** (5-7d, activo) → **CHANNEX-UX-E2-E3** (9-13d, cancel push + grupos multi-room, plan aprobado 2026-05-23) → **NOVA-CHANNEX-COMMAND-CENTER** (16-20d, incluye Nova foundation fase 1 — 5-tier RBAC + Partner schema + wizard integration — además del multi-OTA control center, plan aprobado 2026-05-23 Late PM) → **CHECK-IN modal redesign** (1-2d) → **RATES-METRICS-COMPSET-CORE** (20-23d, revenue blocker, plan docs/sprints/RATES-METRICS-COMPSET-CORE-plan.md) → **QA-α mobile** (4-5d) → **CI-RESCUE residual** (0.5-1d). Total ~56-74 días-dev secuencial = ~11-15 semanas calendar. Target tag v1.0.0: agosto-octubre 2026.
...
> **Sprint NOVA-CHANNEX-COMMAND-CENTER — propuesta arquitectónica aprobada 2026-05-23 Late PM; implementación pendiente como parte de Phase 1 Nova foundation. Plan técnico [docs/sprints/CHANNEX-COMMAND-CENTER-plan.md](docs/sprints/CHANNEX-COMMAND-CENTER-plan.md) (16-20 días-dev). ADR permanente [docs/architecture/NOVA-architecture.md](docs/architecture/NOVA-architecture.md). Diferenciador comercial documentado: ningún PMS boutique LATAM cubre interfaz consultor dedicada + impersonation SAP-style + Partner program PartnerEdge alineado.**
