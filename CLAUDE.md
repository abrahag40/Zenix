...
> **Estado:** **Sprints 0-1 CERRADOS (2026-06-13/14)**. Sprints 2-6 pendientes. Plan SCRUM completo en **[docs/sprints/MIGRATION-CORE-plan.md](docs/sprints/MIGRATION-CORE-plan.md)**. Módulo comercial 9 en [zenix-sales-master.md](docs/zenix-sales-master.md). v1.1.x DLC/servicio — **NO bloquea v1.0.0**. **Próximo: Sprint 2 (CollisionDetector ★ — detección de empalmes).**
>
