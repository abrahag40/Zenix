...
- **📋 TABLA DE SEGUIMIENTO AUTO-CHECKIN** (se actualiza + reporta al cerrar cada fase; fuente de verdad anti-pérdida-de-sesión):
  ...
  | **3 — Integración recepción + storage** | `ConfirmCheckinDialog`/sheet reflejan "identidad pre-cargada por el huésped" + foto visible **auth-gated**; política de retención (~30d post-checkout, configurable) | UI recepción + retención | ⏳ |
  | **4 — QA e2e + navegador móvil** | Verificación end-to-end en navegador móvil real (3 superficies) + bitácora | reporte QA | ⏳ |
