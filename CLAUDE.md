...
>
> **Rama `claude/zenix-learning-lms-v1-2qz8l` (LEARNING-CORE, en progreso sobre este merge):** Zenix Learning LMS como Add-On/DLC. Research completo en `docs/zenix-learning/` (11 docs) + Game A "Auditoría Sorpresa" ejecutable (Phaser 3 + TS + Vite) en `lms-standalone/games/game-a-auditoria-sorpresa/`. Target merge: v1.0.0 ideal / v1.1.0 fallback. Decisiones §128-§137 reservadas al cerrar sprint.
