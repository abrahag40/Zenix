...
> **Última actualización:** 2026-05-18 PM (Sprint MOVE-CONFIRM lightweight cerrado — §127 registrada: `confirmSegmentMove` endpoint con 2-phase HK promotion. Plan BOOKING-ENGINE creado con estudio de mercado completo en `docs/sprints/BOOKING-ENGINE-plan.md` — combo PMS + Direct Booking Engine + Website + Marketing como diferencial LATAM vs Cloudbeds/Mews. 13/13 tests stay-journeys passing.)
