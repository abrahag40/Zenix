...
- **v1.1.1** — IA tarifaria heurística + Pickup/Pace avanzados + **Zenix Market Intel Pro DLC** (swap compset MVP → Lighthouse partnership + Eventbrite/Songkick ingest automático + auto-radius detection + push notifications "competitor changed rate"). Pricing $50-80/property/mes. El adapter `ICompsetAdapter` ya queda listo en RATES-METRICS-COMPSET-CORE sprint anterior.
